...
type UploadStep = "basic" | "specs" | "condition" | "pricing" | "images" | "admin";
...
export default function AdminVehicleUploadPage() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      toast({
        title: "Success!",
        description: `Vehicle uploaded successfully with status: ${formData.status}`,
      });
  ...
  return (
    <div className="p-8 space-y-6">
      {/* Header */}
      <div>
        <h1 className="text-3xl font-bold mb-2">Upload New Vehicle (Admin)</h1>
        <p className="text-muted-foreground">
          Add a vehicle to the platform with admin privileges
        </p>
      </div>
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground mt-2">
                Note: Image upload to Convex storage will be implemented in production. For now, placeholder images will be used.
              </p>
            </div>
          </div>
        )}
        ...
        {currentStep === "admin" && (
          <div className="space-y-6">
            ...
            <p className="text-sm text-muted-foreground">
              Set the initial status and approval notes for this vehicle
            </p>
            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="text-xs text-muted-foreground mt-1">
                  As an admin, you can set the vehicle status directly
                </p>
              </div>
              ...
              <div>
                ...
                <Textarea
                  ...
                  onChange={(e) => updateFormData("approvalNotes", e.target.value)}
                  placeholder="Add any notes about this vehicle's approval status..."
                  rows={4}
                />
                <p className="text-xs text-muted-foreground mt-1">
