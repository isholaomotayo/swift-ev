...
const guideSections = [
  ...
  },
  {
    ...
    summary: "What happens after you win, invoice issuance, and China remittance verification.",
    blocks: [
      {
        type: "steps",
        title: "Purchase decision & remittance steps",
        items: [
          "Vehicle Inspection & Decision: Review the comprehensive 180-point inspection report to confirm vehicle condition.",
          "Proforma Invoice (PI) & Contract: Upon purchase decision, we issue a PI and sign a legally binding contract (if a 3rd party is involved, a Payment Agreement is executed).",
          "Remittance to China: Payment remittance takes approximately 4–5 working days to reach China.",
          "Fund Reception & Verification: Funds are verified against the contract, converted into domestic USD/EUR, and exchanged into local RMB (1–2 working days).",
        ],
        note: "72-hour invoice payment deadline applies to secure auction and buy-now allocations.",
      },
      {
        type: "cards",
        ...
        items: [
          ...
          },
          {
            ...
            description: "Direct escrow wire settlement with contract-backed fund verification.",
            icon: <Shield className="h-4 w-4" />,
          },
          {
            title: "Card Payment",
            description: "Visa, Mastercard, and Verve accepted for instant invoice settlement.",
            icon: <BadgeCheck className="h-4 w-4" />,
          },
          {
            title: "Split Payment & 3rd Party",
            description: "Combine wallet balance with bank transfer under standard Payment Agreements.",
            icon: <ClipboardList className="h-4 w-4" />,
          },
        ],
      },
      {
        ...
        items: [
          "Vehicle purchase price / winning bid amount",
          "Buyer premium (5%)",
          "Documentation & inspection fees",
          "Confirmed ocean freight & destination logistics",
          "Customs clearance estimate (fixed-fee guarantee)",
  ...
  },
  {
    ...
    summary: "7-step China-to-destination export lifecycle, containerization rules, and DHL customs document tracking.",
    blocks: [
      {
        type: "steps",
        title: "The 7-step export & shipping workflow",
        items: [
          "1. Vehicle Inspection & Purchase Decision: Comprehensive inspection provided. Proforma Invoice (PI) issued, contract signed (plus Payment Agreement for 3rd parties). Remittance takes 4–5 working days to China.",
          "2. Fund Reception & Verification: Funds verified against contract, converted to domestic USD/EUR, and exchanged into local RMB (1–2 working days).",
          "3. Vehicle Purchase & Registration: Vehicle purchased and registered under AutoCango (the licensed car exporter) (2–3 working days).",
          "4. Export License Application & Vehicle Transfer: Vehicle transferred to Shanghai while export license is processed (4–7 working days, concurrent with purchase & registration).",
          "5. Containerization & Shipping: Containerized in Shanghai. Dedicated container (min. 3 units) or Shared Container service with other vehicles (4–7 working days preparation).",
          "6. Customs Declaration & Document Preparation: Export declaration completed before departure from Shanghai Port. Customs clearance documents are issued after vessel departure and sent via DHL 20–10 days before ship arrival.",
          "7. Shipping & Customs Clearance: Ocean transit takes 50–70 days (shortened to 35–45 days on active routes). Use provided DHL original documents for port customs clearance.",
        ],
        note: "Important: Ocean freight rates fluctuate and must be confirmed for each shipment. Customs clearance documents can only be provided after the vessel has departed.",
      },
      {
        type: "cards",
        title: "Container options & logistics",
        columns: "md:grid-cols-2",
        items: [
          {
            title: "Dedicated Container (Min. 3 Units)",
            description: "Requires a minimum of 3 units. As soon as all your vehicles arrive in Shanghai, they are containerized immediately without waiting for consolidation.",
            icon: <Truck className="h-4 w-4" />,
          },
          {
            title: "Shared Container Service (< 3 Units)",
            description: "For orders under 3 units, your vehicle is professionally consolidated in Shanghai in a shared container alongside other verified customer vehicles.",
            icon: <ClipboardList className="h-4 w-4" />,
          },
        ],
      },
      {
        type: "table",
        title: "Workflow timeframes summary (Working Days)",
        columns: ["Stage", "Phase Description", "Estimated Working Days"],
        rows: [
          ["Stage 1", "Remittance Process to China", "4–5 days"],
          ["Stage 2", "Fund Reception & Verification (USD/EUR → RMB)", "1–2 days"],
          ["Stage 3", "Vehicle Purchase & AutoCango Registration", "2–3 days"],
          ["Stage 4", "Export License Application & Shanghai Transfer", "4–7 days (Concurrent)"],
          ["Stage 5", "Shanghai Containerization Preparation", "4–7 days (Maybe faster)"],
          ["Stage 6", "Customs Declaration & DHL Document Dispatch", "DHL sent 20–10 days prior to arrival"],
          ["Stage 7", "Ocean Shipping Duration (Liner Dependent)", "35–70 days (Expected 35–45 days)"],
        ],
        note: "Ocean freight rates fluctuate with global liner markets and must be confirmed for each shipment.",
      },
      {
        type: "bullets",
        title: "Customs clearance documents via DHL",
        items: [
          "Documents provided strictly after vessel departure from Shanghai Port.",
          "Original Bill of Lading (B/L), export certificate, commercial invoice, and inspection report.",
          "Dispatched via DHL express courier 20–10 days before ship arrives at port.",
          "Real-time GPS vessel tracking and DHL courier tracking available in your dashboard.",
        ],
      },
    ],
  },
